...
\setlength{\cftbeforelottitleskip}{0pt plus 1pt} % sets the space before the list of tables to match sections
    ...
    \section{Implementation}
        ...
        \subsection{User Profile}
            ...
            \begin{figure}[H]
                \centering
                \begin{subfigure}{0.31\textwidth}
                    \includegraphics[width=\linewidth]{Images/profile_screen_1.png}
                    \caption{Profile Screen - iOS}
                    \label{fig:profile_screen_1}
                \end{subfigure}
                \begin{subfigure}{0.31\textwidth}
                    \includegraphics[width=\linewidth]{Images/profile_screen_2.png}
                    \caption{Profile Screen Phone No. URL - iOS}
                    \label{fig:profile_screen_2}
                \end{subfigure}
                \begin{subfigure}{0.31\textwidth}
                    \includegraphics[width=\linewidth]{Images/profile_screen_3.jpg}
                    \caption{Profile Screen Edit - Android}
                    \label{fig:profile_screen_3}
                \end{subfigure}
                \begin{subfigure}{0.31\textwidth}
                    \includegraphics[width=\linewidth]{Images/profile_screen_4.jpg}
    ...
    \pagebreak
    \section{Future Work}
            \subsubsection{Adding More Stations} 
            ...
            \subsubsection{Organized Customer Support System}
            ...
            \subsubsection{In-App Payment for Trip}
            ...
            \subsubsection{Roads Status Telegram Channel Integration}
            ...
            \subsubsection{Predefined and Saved Trip Routes for Drivers}
            ...
            \subsubsection{More Language Support}
            ...
            \subsubsection{More Login Options}
            ...
            \subsubsection{Sharable Trip Link}
            ...
            \subsubsection{Carplay and Android Auto Support}
    ...
    \appendix
        ...
        \chapter{Used Libraries and Packages} \label{appendix:libraries}
            ...
            \begin{enumerate}
                \item \textbf{firebase\_core:} Firebase bindings for Flutter.
                \item \textbf{firebase\_auth:} Plugin to enable Firebase Authentication for Flutter. Creates user session and enables sing-in, sign-up, and sign-out, as well as password reset.
                \item \textbf{cloud\_firestore} Plugin that enables Flutter to read and write to Firebase Firestore database.
                \item \textbf{firebase\_storage:} A plugin to use the Firebase Cloud Storage API in Flutter.
                \item \textbf{firebase\_messaging} A Firebase Cloud Messaging (FCM) plugin to deliver messages and enable push notifications in Flutter.
                \item \textbf{google\_maps\_flutter:} A plugin made by Google to integrate Google Maps in Flutter. It communicates with Google Maps API. 
                \item \textbf{riverpod, riverpod\_annotation, flutter\_riverpod:} State management library for Flutter.
                \item \textbf{riverpod\_generator} Code generation for Riverpod.
                \item \textbf{freezed,freezed\_annotation, json\_annotation, json\_serializable}: Code generation for immutable classes which allows for creating model classes with autogenerated serialization and deserialization methods.
                \item \textbf{build\_runner} Flutter package to generate code. Used to generate Freezed, Json serialization, and Riverpod code. 
                \item \textbf{flutter\_platform\_widgets:} A Flutter wrapper library to make creating widgets designed for Android and iOS easier.
                \item \textbf{hl\_image\_picker} A plugin to pick images from the gallery app or take a photo using the camera in in iOS and Android.
                \item \textbf{email\_validator:} An advanced email validation library.
                \item \textbf{flutter\_pw\_validator} A package used to set rules for password creation and validate them.
                \item \textbf{geolocator} A Flutter geolocation plugin that provides easy access to 'platform-specific' location services.
                \item \textbf{permission\_handler} A plugin to request permissions such location and camera and check their status in Flutter for iOS and Android.
                \item \textbf{shared\_preferences} A cross platform Flutter plugin for reading and writing simple key-value pairs and persist them in device storage.
                \item \textbf{cached\_network\_image} A library that fetches photos from the internet and caches them in device storage.
                \item \textbf{flutter\_local\_notifications} A Flutter plugin for displaying local iOS, Android, Linux, and macOS notifications and styling them.
                \item \textbf{timelines} A library to create timeline widgets. It is used in places like the \textit{Trip Detail Screen} to show the trip timeline.
                \item \textbf{workmanager} A Flutter plugin for running background tasks on both Android and iOS.
                \item \textbf{google\_fonts} Flutter package to use Google Fonts in Flutter. Provides the Arabic font \textit{Cairo} used in the app.
                \item \textbf{flutter\_decorated\_text} A package to enable partial text styling in Flutter.
                \item \textbf{dropdown\_button2} A Flutter package to create simple dropdown menus. 
                \item \textbf{connectivity\_plus} A plugin to check if the device is connected to the internet through WiFi, mobile data, or ethernet.
                \item \textbf{cupertino\_icons:} Set of iOS icons to use in Flutter.
                \item \textbf{flutter\_launcher\_icons} Flutter package to create and customize the app icon for both Android and iOS.
                \item \textbf{tuple} A library that enables tuples in Dart.
                \item \textbf{url\_launcher} Plugin to direct urls like phone and email to the device's default url launchers, such as the phone app or email client app.
                \item \textbf{flutter\_native\_splash} Creates a splash screen that appears when launching the app on iOS and Android.
            \end{enumerate}
        ...
        \chapter{The Flow of Starting the App} \label{appendix:post_launch}
             ...
             \begin{figure}[H]
                \centering
                \rotatebox{90}{
                    \includegraphics[width=1.2\textwidth]{Images/start_app_flow.png}}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=1\textwidth]{Images/trip_detail_screen_variations.png}
