...
\usepackage{amsmath} % package used to write mathematical equations
...
\usepackage{adjustbox} % package used to adjust the size of the table
...
\usepackage{picinpar} % used to place figures inside paragraphs
\usepackage{titlesec} % used to customize chapter titles
...
{\normalfont\huge\bfseries}{\chaptertitlename\ \thechapter}{20pt}{\Huge} % removes persistent space before Bibliography and Appendix
...
\setlength{\cftbeforelottitleskip}{0pt plus 1pt} % sets the space before the list of tables to match sections
    \begin{titlepage}
        \begin{center}
            \includegraphics[width=0.5\textwidth]{Images/Birzeit_Logo.jpeg}
    ...
    \indent \section{Introduction } % creates a section
        \subsection{Overview}
            ...
            % //TODO: add develop hitchhiking community
        ...
        \subsection{Technologies}
            ...
            \subsubsection{Firebase}
                ...
                \begin{figure}[h]
                    \centering
                    \includegraphics[width=1\textwidth]{Firebase_Logo.jpeg}
            ...
            \subsubsection{Flutter}
                ...
                \begin{figure}[h] % h means place figure here
                    \centering
                    \includegraphics[width=0.8\textwidth]{Google-flutter-logo.jpeg}
            ...
            \subsubsection{Java Spring Boot (no longer needed)}
                ...
                \begin{figure}[h]
                    \centering
                    \includegraphics[width=1\textwidth]{Spring Boot Logo.jpeg}
            ...
            \subsubsection{Google Maps}
                ...
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=0.6\textwidth]{google_maps_logo.jpeg}
                    \caption{Google Maps Logo \cite{google_maps_logo}}
                    \label{fig:google_maps_logo}
                \end{figure}

        This is not an inclusive list. For all the libraries and plugins we used in developing the app, see appendix \ref{appendix:libraries}.
    ...
    \section{Literature Review and Similar Projects}
        ...
        \subsection{Similar Ideas}
            ...
            \subsubsection{BlaBlaCar}
                ...
                \begin{figure}
                    ...
                    \begin{subfigure}{0.3\textwidth}
                        \includegraphics[width=0.8\linewidth, height=0.9\textheight, keepaspectratio]{Images/Blablacar_search.jpeg}
                        \caption{Search Page}
                        \label{fig:blabla_search}
                    \end{subfigure}
                    \begin{subfigure}{0.3\textwidth}
                        \includegraphics[width=0.8\linewidth, height=0.9\textheight, keepaspectratio]{Images/Blablacar_search_result.jpeg}
                        \caption{Trip Search Results Screen}
                        \label{fig:blabla_results}
                    \end{subfigure}
                    \begin{subfigure}{0.3\textwidth}
                        \includegraphics[width=0.8\linewidth, height=0.9\textheight, keepaspectratio]{Images/Blablacar_trip_detail.jpeg}  
                    ...
                    \newline
                    \begin{subfigure}{0.3\textwidth}
                        \includegraphics[width=0.8\linewidth, height=0.9\textheight, keepaspectratio]{Images/Blablacar_userprofile.jpeg}
                        \caption{User Profile Screen}
                        \label{fig:blabla_profile}
                    \end{subfigure}
                    \begin{subfigure}{0.3\textwidth}
                        \includegraphics[width=0.8\linewidth, height=0.9\textheight, keepaspectratio]{Images/Blablacar_settings.jpeg}
            ...
            \subsubsection{inDrive}
                ...
                \begin{figure}[h]
                    \centering
                    \includegraphics[width=0.9\linewidth]{Images/inDrive_Overview.jpeg}
                ...
                \begin{spacing}{1} % adjusting spacing between lines to lower value so that the table doesn't stretch too long. Text in the table has smaller line spacing due to this.
                   \begin{ThreePartTable}
                        ...
                        \begin{longtable}{| >{\centering\arraybackslash}m{4cm} |c|c|c|s|}
                            ...
                            \hline
                            List and map of trips to destination\tnote{1}
                            & & & & \Large{\checkmark}\\
                            \hline
                            ...
                            \hline
                            Live location of driver\tnote{2}
                            & \checkmark & & \checkmark & \Large{\checkmark}\\
                            \hline
                            ...
                            & \checkmark & \checkmark & & \Large{\checkmark}\\
                            \hline
                            Users can see driver's rating and other passengers' rating in trip\tnote{3}
                            % & & \checkmark & & \Large{\checkmark}\\
                            % \hline
    ...
    \section{Approach}  
        ...
        \subsection{Resources}
            \subsubsection{West Bank Cities Roads Dataset}
                ...
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=0.7\textwidth, keepaspectratio]{Images/Route_Text_Case.jpeg}
        ...
        \subsection{Work Schedule}
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[width=0.9\textwidth]{Images/implemntation_timeline.jpeg}
    ...
    \subsection{Use Cases}
        ...
        \subsubsection{Use Case Diagram}
            ...
            \begin{figure}[H]
                \centering
                \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{Images/CarPal_Usecase.jpeg}}
    ...
    \subsection{Sequence, UML, State, and Deployment Diagrams}
        ...
        \begin{figure}[H]
            \centering
            \rotatebox{90}{
            \includegraphics[width=1.1\textwidth]{Images/login.jpeg}}
        ...
        \begin{sidewaysfigure}[!htb]
            \centering
            \includegraphics[width=0.9\linewidth]{Images/Passenger Accepted.jpeg}
    ...
    % \subsubsection{Reserve Seat sequence Diagram}
        \begin{sidewaysfigure}[!htb]
            \centering
            \includegraphics[width=\linewidth]{Images/Passenger Payment.jpeg}
    ...
    % \subsubsection{show scheduled trips sequence Diagram}
        \begin{sidewaysfigure}[!htb]
            \centering
            \includegraphics[width=\linewidth]{Images/Driver Scheduled.jpeg}
    ...
    % \subsubsection{Driver Accepts trip Request sequence Diagram}
        \begin{sidewaysfigure}[!htb]
            \centering
            \includegraphics[width=\linewidth]{Images/Driver Request.jpeg}
    ...
    % \subsubsection{UML Class Diagram}
        \begin{sidewaysfigure}[!htb]
            \centering
            \includegraphics[width=\linewidth]{Images/UML Class.jpeg}
    ...
    % \subsubsection{State Diagrams}
        \begin{sidewaysfigure}[!htb]
            \centering
            \includegraphics[width=\linewidth]{Images/State Diagram passenger.jpeg}
       ...
       \begin{sidewaysfigure}[!htb]
            \centering
            \includegraphics[width=\linewidth]{Images/State Diagram Driver.jpeg}
        ...
        \begin{sidewaysfigure}[!htb]
            \centering
            \includegraphics[width=\linewidth]{Images/deployment_diagram.jpeg}
    ...
    \section{Implementation}
        ...
        \subsection{User Sign up and Login}
            ...
            \begin{figure}[H]
                \centering
                \begin{subfigure}{0.3\textwidth}
                    \includegraphics[width=0.8\linewidth, height=0.9\textheight, keepaspectratio]{Images/first_screen.jpeg}
                    \caption{App Start Screen}
                    \label{fig:real_first_screen}
                \end{subfigure}
                \begin{subfigure}{0.3\textwidth}
                    \includegraphics[width=0.8\linewidth, height=0.9\textheight, keepaspectratio]{Images/user_login.jpeg}
                    \caption{Login Screen - iOS}
                    \label{fig:real_login}
                \end{subfigure}
                \begin{subfigure}{0.3\textwidth}
                    \includegraphics[width=0.8\linewidth, height=0.9\textheight, keepaspectratio]{Images/user_sign_up_1.jpeg}
                    \caption{Sign Up Screen - Android}
                    \label{fig:real_sign_up_1}
                \end{subfigure}
                \begin{subfigure}{0.3\textwidth}
                    \includegraphics[width=0.8\linewidth, height=0.9\textheight, keepaspectratio]{Images/user_sign_up_2.jpeg}  
                    \caption{Sign Up Screen with Password Validation - Android}
                    \label{fig:real_sign_up_2}
                \end{subfigure}
                \begin{subfigure}{0.3\textwidth}
                    \includegraphics[width=0.8\linewidth, height=0.9\textheight, keepaspectratio]{Images/user_sign_up_3.jpeg}
                    \caption{Cont. Sign Up Screen - Android}
                    \label{fig:real_sign_up_3}
                \end{subfigure}
                \begin{subfigure}{0.3\textwidth}
                    \includegraphics[width=0.8\linewidth, height=0.9\textheight, keepaspectratio]{Images/password_reset.jpeg}
        ...
        \subsection{Trips List Screen}
            \begin{wrapfigure}{r}{0.25\textwidth}
                \centering
                \includegraphics[width=\linewidth]{Images/trip_list_screen.jpeg}
        ...
        \subsection{Driver Trip Creation}
            ...
            \begin{figure}[H]
                \centering
                \begin{subfigure}{0.3\textwidth}
                    \includegraphics[width=\linewidth]{Images/trip_creation_1.jpeg}
                    \caption{Station Selection Sheet - iOS}
                    \label{fig:trip_cration_1}
                \end{subfigure}
                \begin{subfigure}{0.3\textwidth}
                    \includegraphics[width=\linewidth]{Images/trip_creation_2.jpeg}
                    \caption{Trip Date and Time Picker - iOS}
                    \label{fig:trip_cration_2}
                \end{subfigure}
                \begin{subfigure}{0.3\textwidth}
                    \includegraphics[width=\linewidth]{Images/trip_creation_3.jpeg}  
                    \caption{Trip Route Station Selection - iOS}
                    \label{fig:trip_cration_3}
                \end{subfigure}
                \begin{subfigure}{0.3\textwidth}
                    \includegraphics[width=\linewidth]{Images/trip_creation_4.jpeg}  
        ...
        \subsection{Passenger Trip Search}
            ...
            \begin{figure}[H]
                ...
                \begin{subfigure}{0.31\textwidth}
                    \includegraphics[width=\linewidth]{Images/trip_search_1.jpeg}
                    \caption{Station Sheet - Android}
                    \label{fig:trip_search_1}
                \end{subfigure}
                \begin{subfigure}{0.31\textwidth}
                    \includegraphics[width=\linewidth]{Images/trip_search_2.jpeg}
                    \caption{Trip Search Screen - Android}
                    \label{fig:trip_search_2}
                \end{subfigure}
                \begin{subfigure}{0.31\textwidth}
                    \includegraphics[width=\linewidth]{Images/trip_search_3.jpeg}
                    \caption{Search Date Picker - Android}
                    \label{fig:trip_search_3}
                \end{subfigure}
                \begin{subfigure}{0.31\textwidth}
                    \includegraphics[width=\linewidth]{Images/trip_search_4.jpeg}
                    \caption{Trip Search Result - Android}
                    \label{fig:trip_search_4}
                \end{subfigure}
                \begin{subfigure}{0.31\textwidth}
                    \includegraphics[width=\linewidth]{Images/trip_Detail_screen.jpeg}
        ...
        \subsection{User Profile}
            The user profile screen shows a user detail, Figure \ref{fig:profile_screen}. The app profile page shows this screen with the option to edit personal details and profile picture. A user can apply to become driver this screen as well. Moreover, phone and email are urls that can be clicked to call or send an email to the profile owner in case the user's are ride sharing. 
            \begin{figure}[H]
                \centering
                \begin{subfigure}{0.31\textwidth}
                    \includegraphics[width=\linewidth]{Images/profile_screen_1.jpeg}
                    \caption{Profile Screen - iOS}
                    \label{fig:profile_screen_1}
                \end{subfigure}
                \begin{subfigure}{0.31\textwidth}
                    \includegraphics[width=\linewidth]{Images/profile_screen_2.jpeg}
                    \caption{Profile Screen Phone No. URL - iOS}
                    \label{fig:profile_screen_2}
                \end{subfigure}
                \begin{subfigure}{0.31\textwidth}
                    \includegraphics[width=\linewidth]{Images/profile_screen_3.jpeg}
                    \caption{Profile Screen Edit - Android}
                    \label{fig:profile_screen_3}
                \end{subfigure}
                \begin{subfigure}{0.31\textwidth}
                    \includegraphics[width=\linewidth]{Images/profile_screen_4.jpeg}
                    \caption{Profile Screen Edit Confirm - Android}
                    \label{fig:profile_screen_4}
                \end{subfigure}
                \caption{Passenger Trip Search Screens}
        ...
        \subsection{Profile Picture Picker}
            ...
            \begin{figure}[H]
                \centering
                \begin{subfigure}{0.4\textwidth}
                    \includegraphics[width=\linewidth]{Images/pfp_select_1.jpeg}
                    \caption{Profile Picture Picker - iOS}
                    \label{fig:pfp_select_1}
                \end{subfigure}
                \begin{subfigure}{0.4\textwidth}
                    \includegraphics[width=\linewidth]{Images/pfp_select_2.jpeg}
                    \caption{Cont. Profile Picture Picker - iOS}
                    \label{fig:pfp_select_2}
                \end{subfigure}
                % TODO: add Android edit screenshot
    ...
    \section{Evaluation and Testing}
        ...
        \subsubsection{Performance Testing}
            ...
            \subsubsection{Usablity Testing}
                ...
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=\linewidth]{Images/survey_gender.jpeg}
                ...
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=\linewidth]{Images/survey_fields.jpeg}
                ...
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=\linewidth]{Images/survey_2.jpeg}
                ...
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=\linewidth]{Images/survey_1.jpeg}
                ...
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=\linewidth]{Images/will_you_use.jpeg}
                    \caption{Whether surveyed people would use the app or not}
                    \label{fig:will_you_use}
                \end{figure}

                % in which we asked the different users, who we have given the application to, to give us feedback on the application, and to tell us if they found the application easy to use, and if they were able to find the different features and functionalities that the application has.
    ...
    \pagebreak
    \section{Future Work}
            \subsection{Adding More Stations} 
            ...
            \pagebreak
            \subsection{Roads Status Telegram Channel Integration}
            The whole idea of the app is to create a ridesharing solution that works in Palestine. We are committed to this cause and that's why we look for ways to make the app more relevant locally. One of these ideas is adding integration with Telegram channel "أحوال الطرق" that provides in time updates on road conditions, checkpoints, and other important information that can help drivers plan and finish their trips more effectively. We are planning to add Telegram message forwarding from this channel to a server we could use to send notifications and status updates to the app whenever the app user is undergoing a trip to affected area.

            \subsection{Predefined and Saved Trip Routes for Drivers}
            ...
            \subsection{More Language Support}
            ...
            % \subsubsection{Adding social and Groups features}
            % An idea that accord to us was to add simple social features, such as creating groups and weekly scheduled trips, so users can join groups and trips that are scheduled to happen weekly or daily, where the idea accord to us when we thought about company workers, and we thought it would be a great addition to the program, as the thought process was to make the app more social and allow companies to join in, as adding this feature would allow us to add a new type of accounts such as "company account", and make it possible for this user to create a group of its employees who live nearby each others, then they can schedule a trip that happens daily or weekly, and the app will automatically notify the users in the group about the trip, the driver can be someone an employee who has a car, and he is getting payments from the company or the other employees, much more scenarios can be thought of, and we think this feature would be a great addition to the app.
            \subsection{Carplay and Android Auto Support}
    ...
    \appendix
        ...
        \chapter{Used Libraries and Packages} \label{appendix:libraries}
            The following list includes Flutter libraries and packages used in creating the App. All these packages support both Android and iOS platforms and are downloaded from  \href{https://pub.dev}{\textit{\url{pub.dev}}} the home repository of Dart and Flutter plugins. Additionally, all the packages are up to date and compatible with the latest stable version of Flutter 3.22.2 and Dart 3.4.3 as of the time of writing this report, 26th of June 2024. 
            \begin{spacing}{1}
                \begin{longtable}{|R{5cm}|R{10cm}|}
                    \rowcolor{gray} \textbf{Library/ Plugin} & \textbf{Description}\\
                    \endfirsthead
                    
                    % \toprule
                    \rowcolor{gray} \textbf{Library/ Plugin} & \textbf{Description}\\                    % \midrule
                    \endhead
                    \caption{Libraries and plugins used in the app \label{tab:libraries_and_plugins}}\\
                    
                    \endfoot
                    \caption*{Libraries and plugins used in the app (continued)}\\
                    % \bottomrule
                    % \insertTableNotes 
                    \endlastfoot
                    \hline
                    \textbf{firebase\_core} & Firebase bindings for Flutter. \\
                    \hline
                    \textbf{firebase\_auth} & Plugin to enable Firebase Authentication for Flutter. Creates user session and enables sign-in, sign-up, and sign-out, as well as password reset. \\
                    \hline
                    \textbf{cloud\_firestore} & Plugin that enables Flutter to read and write to Firebase Firestore database. \\
                    \hline
                    \textbf{firebase\_storage} & A plugin to use the Firebase Cloud Storage API in Flutter. \\
                    \hline
                    \textbf{firebase\_messaging} & A Firebase Cloud Messaging (FCM) plugin to deliver messages and enable push notifications in Flutter. \\
                    \hline
                    \textbf{google\_maps\_flutter} & A plugin made by Google to integrate Google Maps in Flutter. It communicates with Google Maps API. \\
                    \hline
                    \textbf{riverpod, riverpod\_annotation, flutter\_riverpod} & State management library for Flutter. \\
                    \hline
                    \textbf{riverpod\_generator} & Code generation for Riverpod. \\
                    \hline
                    \textbf{freezed, freezed\_annotation, json\_annotation, json\_serializable} & Code generation for immutable classes which allows for creating model classes with autogenerated serialization and deserialization methods. \\
                    \hline
                    % \textbf{build\_runner} & Flutter package to generate code. Used to generate Freezed, Json serialization, and Riverpod code. \\
                    % \hline
                    \textbf{flutter\_platform\_widgets} & A Flutter wrapper library to make creating widgets designed for Android and iOS easier. \\
                    \hline
                    \textbf{hl\_image\_picker} & A plugin to pick images from the gallery app or take a photo using the camera in iOS and Android. \\
                    \hline
                    \textbf{email\_validator} & An advanced email validation library. \\
                    \hline
                    \textbf{flutter\_pw\_validator} & A package used to set rules for password creation and validate them. \\
                    \hline
                    \textbf{geolocator} & A Flutter geolocation plugin that provides easy access to 'platform-specific' location services. \\
                    \hline
                    \textbf{permission\_handler} & A plugin to request permissions such as location and camera and check their status in Flutter for iOS and Android. \\
                    \hline
                    \textbf{shared\_preferences} & A cross-platform Flutter plugin for reading and writing simple key-value pairs and persisting them in device storage. \\
                    \hline
                    \textbf{cached\_network\_image} & A library that fetches photos from the internet and caches them in device storage. \\
                    \hline
                    \textbf{flutter\_local\_notifications} & A Flutter plugin for displaying local iOS, Android, Linux, and macOS notifications and styling them. \\
                    \hline
                    \textbf{timelines} & A library to create timeline widgets. It is used in places like the \textit{Trip Detail Screen} to show the trip timeline. \\
                    \hline
                    \textbf{workmanager} & A Flutter plugin for running background tasks on both Android and iOS. \\
                    \hline
                    \textbf{google\_fonts} & Flutter package to use Google Fonts in Flutter. Provides the Arabic font \textit{Cairo} used in the app. \\
                    \hline
                    \textbf{flutter\_decorated\_text} & A package to enable partial text styling in Flutter. \\
                    \hline
                    \textbf{dropdown\_button2} & A Flutter package to create simple dropdown menus. \\
                    \hline
                    \textbf{connectivity\_plus} & A plugin to check if the device is connected to the internet through WiFi, mobile data, or ethernet. \\
                    \hline
                    \textbf{cupertino\_icons} & Set of iOS icons to use in Flutter. \\
                    \hline
                    \textbf{flutter\_launcher\_icons} & Flutter package to create and customize the app icon for both Android and iOS. \\
                    \hline
                    \textbf{tuple} & A library that enables tuples in Dart. \\
                    \hline
                    \textbf{url\_launcher} & Plugin to direct URLs like phone and email to the device's default URL launchers, such as the phone app or email client app. \\
                    \hline
                    \textbf{flutter\_native\_splash} & Creates a splash screen that appears when launching the app on iOS and Android. \\
                    \hline
                \end{longtable}
            \end{spacing}
        \chapter{State Management Overview} \label{appendix:state_management}
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[width=0.9\textwidth]{Images/state_management.jpeg}
                \caption{Application State Management Overview}
                \label{fig:state_management}
            \end{figure}
    
        \chapter{The Flow of Starting the App} \label{appendix:post_launch}
             \begin{figure}[H]
                \centering
                \rotatebox{90}{
                    \includegraphics[width=1.2\textwidth]{Images/start_app_flow.jpeg}}
                    \caption{App Start Flow}
                \label{fig:app_start}
            \end{figure} 
    
        \chapter{Trip Detail Screen Flow} \label{appendix:trip_detail}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=1\textwidth]{Images/trip_detail_screen_variations.jpeg}
