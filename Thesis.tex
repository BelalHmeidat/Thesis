...
\begin{document} 
    ...
    \section{Approach}  
        \subsection{Methodology}
            To ensure an effective development process, we have adopted the Agile development methodology \cite{agile_method} as the software development process we will be taking throughout our journey.
