...
\begin{document} 
    ...
    \section{Approach}  
        ...
        \subsection{Work Schedule}
            \subsubsection{Report Work Schedule}
                \begin{table}[h]
                \caption{Work plan for the report tasks and the time needed to achieve them starting from 08/11/2023}
                \label{1stSemWorkPlanTable}
                    \begin{center}
                        \begin{tabular}{m{10cm}|c}
                            ...
                            \hline
                            Setting up Firebase Database & 1 week \\
                            Setting Up Flutter Application with end user Enrolment and Authentication & 1 week\\
                            Trip Creation Login and Booking logic & 3 week \\
                            Device Location and Map Service Integration & 2 week \\
                            User Profiles and Trip Filters & 1 week \\
                            % Learning software tools and frameworks needed & 2 weeks \\
                            Tuning and Testing & 2 weeks \\ 
                    ...
                    \end{center}
                \end{table}
            \subsubsection{Implementation Work Schedule}
    ...
    \section{Evaluation and Testing}
        ...
        \subsection{Functional Testing}
            ...
            \subsubsection{Login and Registration test}
                ...
                A- User is already a member: user can choose to login via email and password or via phoneNo, in which on a successful login attempt he will see the home page.
                B- New user in which he will click signup button and enter his credintials and information to create an account, on successful signup user is required to verify his email address by entering a link sent to his email, before processing to the home page.
                C-  User is already a member but he forgot his password: in which he will enter his email or phone number, and a message to reset his password will be sent to him.
                % TODO: a table of Login Test cases don't 
                (Note: Tables will be added to provide a clearer overview of the test scenarios.)
            \subsubsection{Search A Trip test}
                ...
                A- finding matching trips, in which a split screen is shown with the map and driver last seen locations on it, and a card list in which trip informations are listed.
                B- No matching trip is found, in which the user is prompted and told that no matching trips are found.
                C- User missed to enter a required field, in which the user is prompted to enter the missing field.
                (Note: Tables will be added to provide a clearer overview of the test scenarios.)
            \subsubsection{Book a Trip test}
                ...
                A- User has a payment method, in which the user will be redirected to the home page.
                B- User has no payment method, in which the user will be prompted to enter a payment method.
                C- User returned to the previous page, in which the trip search screen is shown again.
            ...
            \subsubsection{Create a Trip for Driver test}
                ...
                A- Trip is created successfully, in which the user is redirected to the trip details page.
                B- User missed to enter a required field, in which the user is prompted to enter the missing field.
                C- User returned to the previous page, in which the home page is shown again.
                (Note: Tables will be added to provide a clearer overview of the test scenarios.)
